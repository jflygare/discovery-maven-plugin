...
public class DEPLayout extends SpringLayout {

	protected static final String MINIMUMLEVELKEY = "DEPLayout.minimumLevel";
	// Simpler than the "pair" technique.
	static int graphHeight;
	static int numRoots;
	final double SPACEFACTOR = 1.3; //The higher the closer together (horizontally)
...
//				setRoot(v);
//				System.out.println(StringLabeller.getLabeller(g).getLabel(v) + " IS ROOT NODE");
//				numRoots++;
//			}
//		}
//	}
	...
	public static void setRoot(Graph g) {
		...
		while (iter.hasNext()) {
			v = (Vertex) iter.next();
			predecessors = v.getPredecessors();
...
//	}
	...
	protected void initializeLocation(
		...
		System.out.println("DIMENTIONS = " + d);
